    ...
    models: [
      {
        ...
        description: "OpenAI's latest frontier model, unifying the Codex and GPT lines into a single system. Features a 1M+ token context window with text and image inputs, delivering strong performance on coding, document understanding, tool use, and instruction following.",
      ...
      },
      {
        ...
        description: 'Faster, more efficient variant of GPT-5.4 optimized for high-throughput workloads. Supports text and image inputs with strong reasoning, coding, and tool-use performance at reduced latency and cost — well-suited for chat applications, coding assistants, and agent workflows at scale.',
      ...
      },
      {
        ...
        description: "Google's high-efficiency model optimized for high-volume use cases. Outperforms Gemini 2.5 Flash Lite on overall quality and approaches Gemini 2.5 Flash performance, with improvements across audio/ASR, RAG ranking, translation, data extraction, and code completion. Configurable thinking levels and half the cost of Gemini 3 Flash.",
      ...
      },
      {
        ...
        description: 'Instruction-tuned Mixture-of-Experts (MoE) model from Google DeepMind. Activates only 3.8B of its 25.2B parameters per token, delivering near-31B quality at a fraction of the compute cost. Multimodal (text, image, video) with a 256K context window, native function calling, and Apache 2.0 license.',
      ...
      },
      {
        ...
        name: 'Grok 4.3',
        model: 'x-ai/grok-4.3',
        description: 'xAI reasoning model with always-on reasoning that cannot be disabled or configured by effort level. Accepts text and image inputs with a 1M token context window and no output limit, making it well-suited for long-document analysis, deep research, agentic workflows, and multi-step tasks requiring high factual accuracy.',
      ...
      },
      {
        ...
        description: "Next-generation Opus from Anthropic, built for long-running asynchronous agents. Delivers stronger performance on complex multi-step tasks, large codebases, and end-to-end project orchestration. Also strong at knowledge work — drafting documents, building presentations, and analyzing data — with coherence maintained across very long outputs and extended sessions.",
      ...
      },
      {
        ...
        description: "Fast, efficient model from Alibaba's Qwen 3.6 series. Supports text, image, and video input with a 1M token context window. Tiered pricing applies above 256K tokens; prompt caching is supported with explicit cache read and creation pricing.",
      ...
      },
      {
        ...
        description: "Mixture-of-experts (MoE) model from Meta with 17B active parameters out of 109B total, using 16 experts per forward pass. Native multimodal input (text + image), multilingual output across 12 languages, and a 10M token context window. Tuned for assistant-style interaction, captioning, and visual reasoning, with early-fusion multimodality.",
      ...
      },
      {
        ...
        description: "High-capacity multimodal MoE model from Meta with 128 experts and 17B active parameters (400B total). Supports multilingual text and image input across 12 languages, a 1M token context window, and early-fusion native multimodality. Optimized for vision-language tasks and assistant-like behavior at high throughput.",
      ...
      },
      {
        ...
        description: "Meta's instruction-tuned 70B multilingual model, optimized for dialogue and outperforming many open-source and closed chat models on industry benchmarks. Supports English, German, French, Italian, Portuguese, Hindi, Spanish, and Thai. Free tier — text in / text out only.",
